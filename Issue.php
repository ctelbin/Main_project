...
<body>
    ...
    <div class="top-header">
        ...
        <div class="privacy">
            <div class="container">
                <h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Write us / Send Issue details</h3>
                <form name="enquiry" method="post">
                    ...
                    <p style="width: 350px;">
                        ...
                        <select name="issue" id="user" class="form-control">
                            <option value="" disabled selected hidden>Select Query</option>
                            <option value="Booking issues" class="company" id="company">Booking Issues</option>
