    ...
    <div class="banner-3">
        <div class="container">
            <h1 class="wow zoomIn animated animated" data-wow-delay=".5s"
                style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> TRAVELLO -Package Details
            </h1>
        </div>
    </div>
    <!--- /banner ---->
  ...
  $date = date("d/m/Y")." ".date("h:i:sa");
	...
	?>
                    ...
                    <div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
                        ...
                        <div class="ban-bottom">
                            <div class="bnr-right">
                                ...
                                <input type="date" id="adatepicker" type="text" placeholder="dd-mm-yyyy" name="fromdate"
                                    required="">
                            </div>
                ...
                <div class="selectroom_top">
					...
					{?>
                        <div align="center">
                            <button name="submit2" class="btn-primary btn">Book</button>
