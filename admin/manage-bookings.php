					...
					<div class="agile-tables">
						<div class="w3l-table-info">
							...
							<table id="table">
								...
								<tbody>
									<?php $sql = "SELECT tblbooking.BookingId as bookid,register.name as fname,register.email as email,tbltourpackages.PackageName as pckname,tblbooking.PackageId as pid,tblbooking.FromDate as fdate,tblbooking.RegDate as tdate,tblbooking.status as status,tblbooking.CancelledBy as cancelby,tblbooking.UpdationDate as upddate from register join  tblbooking on  tblbooking.UserEmail=register.email join tbltourpackages on tbltourpackages.PackageId=tblbooking.PackageId";
									$query = $dbh->prepare($sql);
									$query->execute();
