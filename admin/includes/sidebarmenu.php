<div class="sidebar-menu">
	...
	<div class="menu">
		<ul id="menu">
			...
			<li id="menu-academico"><a href="manage-traveller.php"><i class="fa fa-globe" aria-hidden="true"></i><span>Manage Travellers</span>
					<div class="clearfix"></div>
				</a></li>
			<li id="menu-academico"><a href="manage-company.php"><i class="fa fa-globe" aria-hidden="true"></i><span>Manage Tour Companies</span>
					<div class="clearfix"></div>
				</a></li>
			<li><a href="manage-bookings.php"><i class="fa fa-table"></i> <span>Manage Booking</span>
					<div class="clearfix"></div>
				</a></li>
