		...
		<div class="page-container">
			...
			<div class="left-content">
				<div class="mother-grid-inner">
					<!--header start here-->
					<?php include('includes/companydheader.php'); ?>
					<div class="clearfix"> </div>
				</div>
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="companyDashboard.php?uname=<?php echo $cname ?>">Home</a><i class="fa fa-angle-right"></i>Manage Packages</li>
				</ol>
					...
					<div class="agile-tables">
						<div class="w3l-table-info">
							...
							<table id="table">
								...
								<tbody>
									<?php $sql = "SELECT * from TblTourPackages where compname='$cname'";
